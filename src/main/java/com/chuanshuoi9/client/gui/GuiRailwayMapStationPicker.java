...
public class GuiRailwayMapStationPicker extends GuiScreen {
    ...
    private final GuiTrainTimetable parent;
    ...
    public GuiRailwayMapStationPicker(GuiTrainTimetable parent, int stopIndex, BlockPos selected) {
        this.parent = parent;
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (mouseButton == 0) {
            ...
            if (picked != null) {
                ...
                parent.applyPickedStation(stopIndex, picked);
                mc.displayGuiScreen(parent);
                return;
            }
            status = "只能在站台标记点上选择";
