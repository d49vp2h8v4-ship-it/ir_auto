...
public class ModItemModels {
    ...
    public static void registerModels(ModelRegistryEvent event) {
        ...
        ModelLoader.setCustomModelResourceLocation(ModItems.TIMETABLE_TEMPLATE_EDITOR, 0, new ModelResourceLocation(ModItems.TIMETABLE_TEMPLATE_EDITOR.getRegistryName(), "inventory"));
