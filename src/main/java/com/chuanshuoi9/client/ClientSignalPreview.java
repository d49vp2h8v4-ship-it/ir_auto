...
public class ClientSignalPreview {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (mc.player.getHeldItemMainhand().getItem() != ModItems.TRAIN_SIGNAL
            && mc.player.getHeldItemOffhand().getItem() != ModItems.TRAIN_SIGNAL
            && mc.player.getHeldItemMainhand().getItem() != ModItems.SIGNAL_3
            && mc.player.getHeldItemOffhand().getItem() != ModItems.SIGNAL_3) {
            return;
        }
