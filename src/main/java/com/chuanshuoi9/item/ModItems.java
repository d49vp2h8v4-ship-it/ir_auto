...
public class ModItems {
    ...
    public static final ItemTimetableTemplateEditor TIMETABLE_TEMPLATE_EDITOR = new ItemTimetableTemplateEditor();
    ...
    public static final ItemSignal3 SIGNAL_3 = new ItemSignal3();
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().register(TIMETABLE_TEMPLATE_EDITOR);
        ...
        event.getRegistry().register(SIGNAL_3);
