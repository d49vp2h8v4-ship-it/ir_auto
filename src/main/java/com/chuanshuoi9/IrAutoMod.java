...
import com.chuanshuoi9.network.TimetableTemplateListSyncMessage;
import com.chuanshuoi9.network.TimetableTemplateLoadRequestMessage;
import com.chuanshuoi9.network.TimetableTemplateLoadSyncMessage;
...
import com.chuanshuoi9.irfix.IrAutoChunkLoadingCallback;
import com.chuanshuoi9.virtual.VirtualTrainConfig;
import com.chuanshuoi9.virtual.VirtualTrainManager;
...
public class IrAutoMod
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        VirtualTrainConfig.load(event.getSuggestedConfigurationFile());
        ForgeChunkManager.setForcedChunkLoadingCallback(this, new IrAutoChunkLoadingCallback());
        ...
        NETWORK.registerMessage(TimetableTemplateListRequestMessage.Handler.class, TimetableTemplateListRequestMessage.class, 24, Side.SERVER);
        NETWORK.registerMessage(TimetableTemplateListSyncMessage.Handler.class, TimetableTemplateListSyncMessage.class, 25, Side.CLIENT);
        NETWORK.registerMessage(TimetableTemplateLoadRequestMessage.Handler.class, TimetableTemplateLoadRequestMessage.class, 26, Side.SERVER);
        NETWORK.registerMessage(TimetableTemplateLoadSyncMessage.Handler.class, TimetableTemplateLoadSyncMessage.class, 27, Side.CLIENT);
        NETWORK.registerMessage(TimetableTemplateSaveMessage.Handler.class, TimetableTemplateSaveMessage.class, 28, Side.SERVER);
        NETWORK.registerMessage(TimetableTemplateDeleteMessage.Handler.class, TimetableTemplateDeleteMessage.class, 29, Side.SERVER);
        ...
        GameRegistry.registerTileEntity(TileSignal3.class, new ResourceLocation(MODID, "signal_3"));
        
        MinecraftForge.EVENT_BUS.register(new MapSyncTickHandler());
        MinecraftForge.EVENT_BUS.register(new TrainChunkLoader());
        MinecraftForge.EVENT_BUS.register(new VirtualTrainManager());
        MinecraftForge.EVENT_BUS.register(new com.chuanshuoi9.irfix.IrKernelFixer());
        PROXY.preInit(event);
